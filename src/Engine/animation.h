    ...
    Animation(const std::string &path, Model *model)
        {
            ...
            // DEBUG:
            std::cout << "ANIM_DURATION=" << animation->mDuration << std::endl;
            std::cout << "ANIM_TICK_PER_SEC=" << animation->mTicksPerSecond << std::endl;
    ...
    void SetupBones(const aiAnimation* animation, Model& model)
        {
            ...
            auto& boneInfoMap = model.m_OffsetMatMap;
            ...
            // DEBUG:
            std::cout << "BONE_COUNT_SETUP=" << boneCount << std::endl;
        }
    ...
    void ReadHeirarchyData(AssimpNodeData& dest, const aiNode* src)
        {
            ...
            // DEBUG:
            std::cout << "NODE_DATA=" << dest.name << std::endl;
